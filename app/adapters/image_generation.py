...
class OpenAIImageGenerationAdapter:
    ...
    def _color_card_instruction(self, job: GenerationJob) -> str:
        ...
        return (
            ...
            "Exact color-card discipline: final QA will compare the generated film against the "
            "catalog swatch reference image. Keep the perceived base color, value, hue direction, "
            "finish, metallic/pearl/chameleon behavior, and gloss/matte character visually close "
            "to that swatch under plausible lighting; do not drift brighter, darker, bluer, "
            "redder, yellower, or more saturated than the catalog item.\n"
